...
:::tip Multus 插件选择
推荐使用 **Thin Plugin**，无需手动配置且稳定性更好。Thick Plugin 存在已知问题（[OOMKilled #1346](https://github.com/k8snetworkplumbingwg/multus-cni/issues/1346)、[Text file busy #1221](https://github.com/k8snetworkplumbingwg/multus-cni/issues/1221)）。
:::
