...
function NavBar({
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 w-full h-[80px] flex items-center justify-between px-4 md:px-12 bg-black/30 backdrop-blur-[2px] border-b border-neutral-300 z-40 ${className}`}
      >
        {/* 左侧区域包装 */}
