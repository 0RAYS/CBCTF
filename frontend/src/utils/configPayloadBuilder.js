...
export function buildPayload(config) {
  return {
    ...
    k8s_external_network_cidr: config.k8s.external_network.cidr,
    k8s_external_network_exclude_ips: config.k8s.external_network.exclude_ips,
    k8s_external_network_gateway: config.k8s.external_network.gateway,
    k8s_external_network_interface: config.k8s.external_network.interface,
    ...
    nfs_storage: config.nfs.storage,
    path: config.path,
