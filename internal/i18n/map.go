...
var resp = map[string]map[string]any{
	...
	CreateChallengeFlagError: {"zh-CN": "创建题目flag失败", "en-US": "Create ChallengeFlag failed", "code": 500},
	DeleteChallengeFlagError: {"zh-CN": "删除题目flag失败", "en-US": "Delete ChallengeFlag failed", "code": 500},
	GetChallengeFlagError:    {"zh-CN": "获取题目flag失败", "en-US": "Get ChallengeFlag failed", "code": 500},
	ChallengeFlagNotFound:    {"zh-CN": "题目flag不存在", "en-US": "Challenge flag not found", "code": 404},
	UpdateChallengeFlagError: {"zh-CN": "更新题目flag失败", "en-US": "Update ChallengeFlag failed", "code": 500},
	...
	CreateContestChallengeError: {"zh-CN": "添加比赛题目失败", "en-US": "Add ContestChallenge failed", "code": 500},
	DeleteContestChallengeError: {"zh-CN": "删除比赛题目失败", "en-US": "Delete ContestChallenge failed", "code": 500},
	GetContestChallengeError:    {"zh-CN": "获取比赛题目失败", "en-US": "Get ContestChallenge failed", "code": 500},
	ContestChallengeNotFound:    {"zh-CN": "比赛题目不存在", "en-US": "ContestChallenge not found", "code": 404},
	UpdateContestChallengeError: {"zh-CN": "更新比赛题目失败", "en-US": "Update ContestChallenge failed", "code": 500},
	...
	CreateContestFlagError: {"zh-CN": "创建比赛flag失败", "en-US": "Create ContestFlag failed", "code": 500},
	DeleteContestFlagError: {"zh-CN": "删除比赛flag失败", "en-US": "Delete ContestFlag failed", "code": 500},
	GetContestFlagError:    {"zh-CN": "获取比赛flag失败", "en-US": "Get ContestFlag failed", "code": 500},
	ContestFlagNotFound:    {"zh-CN": "比赛flag不存在", "en-US": "ContestFlag not found", "code": 404},
	UpdateContestFlagError: {"zh-CN": "更新比赛flag失败", "en-US": "Update ContestFlag failed", "code": 500},
	...
	CreateTeamFlagError: {"zh-CN": "创建战队flag失败", "en-US": "Create TeamFlag failed", "code": 500},
	DeleteTeamFlagError: {"zh-CN": "删除战队flag失败", "en-US": "Delete TeamFlag failed", "code": 500},
	GetTeamFlagError:    {"zh-CN": "获取战队flag失败", "en-US": "Get TeamFlag failed", "code": 500},
	TeamFlagNotFound:    {"zh-CN": "战队flag不存在", "en-US": "TeamFlag not found", "code": 404},
	UpdateTeamFlagError: {"zh-CN": "更新战队flag失败", "en-US": "Update TeamFlag failed", "code": 500},
	...
	AlreadyVerifiedEmail: {"zh-CN": "邮箱已验证", "en-US": "Email already verified", "code": 400},
	...
	CreateConfigMapError: {"zh-CN": "创建ConfigMap失败", "en-US": "Create ConfigMap failed", "code": 500},
	DeleteConfigMapError: {"zh-CN": "删除ConfigMap失败", "en-US": "Delete ConfigMap failed", "code": 500},
	GetConfigMapError:    {"zh-CN": "获取ConfigMap失败", "en-US": "Get ConfigMap failed", "code": 500},
	ConfigMapNotFound:    {"zh-CN": "ConfigMap不存在", "en-US": "ConfigMap not found", "code": 404},

	CreateNetworkPolicyError: {"zh-CN": "创建NetworkPolicy失败", "en-US": "Create NetworkPolicy failed", "code": 500},
	DeleteNetworkPolicyError: {"zh-CN": "删除NetworkPolicy失败", "en-US": "Delete NetworkPolicy failed", "code": 500},
	GetNetworkPolicyError:    {"zh-CN": "获取NetworkPolicy失败", "en-US": "Get NetworkPolicy failed", "code": 500},
	...
	CreateVPCNatGatewayError: {"zh-CN": "创建VPC NAT网关失败", "en-US": "Create VPCNATGateway failed", "code": 500},
	DeleteVPCNatGatewayError: {"zh-CN": "删除VPC NAT网关失败", "en-US": "Delete VPCNATGateway failed", "code": 500},
	GetVPCNatGatewayError:    {"zh-CN": "获取VPC NAT网关失败", "en-US": "Get VPCNATGateway failed", "code": 500},
	VPCNatGatewayNotFound:    {"zh-CN": "VPC NAT网关不存在", "en-US": "VPCNATGateway not found", "code": 404},
	...
	CreateNetAttError: {"zh-CN": "创建附属网卡失败", "en-US": "Create NetworkAttachment failed", "code": 500},
	DeleteNetAttError: {"zh-CN": "删除附属网卡失败", "en-US": "Delete NetworkAttachment failed", "code": 500},
	GetNetAttError:    {"zh-CN": "获取附属网卡失败", "en-US": "Get NetworkAttachment failed", "code": 500},
	NetAttNotFound:    {"zh-CN": "附属网卡不存在", "en-US": "NetworkAttachment not found", "code": 404},
