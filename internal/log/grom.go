// Package log is copied from gorm.Logger and add trace.ID
package log
...
func (l *gormTraceLogger) Info(ctx context.Context, msg string, data ...interface{}) {
	l.WithField("trace.ID", ctx.Value("trace.ID")).Infof(l.infoStr+msg, append([]interface{}{utils.FileWithLineNum()}, data...)...)
}

// Warn print warn messages
func (l *gormTraceLogger) Warn(ctx context.Context, msg string, data ...interface{}) {
	l.WithField("trace.ID", ctx.Value("trace.ID")).Warnf(l.warnStr+msg, append([]interface{}{utils.FileWithLineNum()}, data...)...)
}

// Error print error messages
func (l *gormTraceLogger) Error(ctx context.Context, msg string, data ...interface{}) {
	l.WithField("trace.ID", ctx.Value("trace.ID")).Errorf(l.errStr+msg, append([]interface{}{utils.FileWithLineNum()}, data...)...)
}
...
func (l *gormTraceLogger) Trace(ctx context.Context, begin time.Time, fc func() (string, int64), err error) {
	...
	if ctx.Value("trace.ID") != nil {
		e = l.WithField("trace.ID", ctx.Value("trace.ID"))
	} else {
		e = l.Entry
	}
