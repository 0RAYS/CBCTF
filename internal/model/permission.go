...
var RoutePermissions = map[string]string{
	...
	"GET /admin/oauth/:oauthID":          PermAdminOauthRead,
	...
	"GET /admin/webhook/:webhookID":         PermAdminWebhookRead,
	...
	"GET /admin/generators/:generatorID/status": PermAdminGeneratorControl,
	...
	"GET /admin/contests/:contestID/challenges/:challengeID":                       PermAdminContestChallengeRead,
	...
	"GET /admin/contests/:contestID/challenges/:challengeID/flags/:flagID":         PermAdminContestChallengeFlagRead,
	...
	"GET /admin/contests/:contestID/generators/:generatorID/status": PermAdminContestGeneratorControl,
...
var Permissions = []Permission{
	...
	{Name: PermAdminSMTPRead, Resource: "admin:smtp", Operation: "read", Description: "查看 SMTP 配置详情"},
	...
	{Name: PermAdminWebhookRead, Resource: "admin:webhook", Operation: "read", Description: "查看 Webhook 详情"},
