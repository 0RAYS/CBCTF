...
var DefaultRolePermissionMap = map[string][]string{
	AdminRoleName: {
		...
		PermAdminContestCreate, PermAdminContestRead, PermAdminContestUpdate, PermAdminContestDelete, PermAdminContestList, PermAdminContestRank, PermAdminContestWriteupExport,
		...
		PermAdminImagePull, PermAdminContestImagePull,
		PermAdminVictimControl, PermAdminContestVictimControl,
		PermAdminGeneratorControl, PermAdminContestGeneratorControl,
		PermAdminTrafficRead, PermAdminContestTrafficRead,
	...
	OrganizerRoleName: {
		...
		PermAdminContestChallengeCreate, PermAdminContestChallengeRead, PermAdminContestChallengeUpdate, PermAdminContestChallengeDelete, PermAdminContestChallengeList,
		PermAdminContestChallengeFlagList, PermAdminContestChallengeFlagRead, PermAdminContestChallengeFlagUpdate,
		PermAdminContestImagePull,
		PermAdminContestVictimControl,
		PermAdminContestGeneratorControl,
		PermAdminContestTrafficRead,
	},
	UserRoleName: {
		PermSelfRead, PermSelfUpdate, PermSelfDelete, PermSelfActivate,
		PermUserContestRead, PermUserContestRank,
