...
const (
	...
	K8SCaptureEnabledSettingKey    = "k8s.capture_enabled"
	K8SPriorityClassSettingKey     = "k8s.priority_class_name"
	K8SWorkerImageSettingKey       = "k8s.worker_image"
	K8SGeneratorPoolSizeSettingKey = "k8s.generator_pool_size"
