...
const (
	...
	CountModelError = "CountModelError"
	...
	CreateUsageError = "CreateUsageError"
	UpdateUsageError = "UpdateUsageError"
	DeleteUsageError = "DeleteUsageError"
	GetUsageError    = "GetUsageError"
	UsageNotFound    = "UsageNotFound"

	CreateFlagError = "CreateFlagError"
	DeleteFlagError = "DeleteFlagError"
	UpdateFlagError = "UpdateFlagError"
	GetFlagError    = "GetFlagError"
	FlagNotFound    = "FlagNotFound"

	CreateAnswerError = "CreateAnswerError"
	DeleteAnswerError = "DeleteAnswerError"
	UpdateAnswerError = "UpdateAnswerError"
	...
	EmptyGeneratorImage        = "EmptyGeneratorImage"
	EmptyContainerImage        = "EmptyContainerImage"
	UpdateContainerError       = "UpdateContainerError"
	StartContainerError        = "StartContainerError"
	StopContainerError         = "StopContainerError"
	...
	CreateFileRecordError      = "CreateFileRecordError"
	DeleteFileRecordError      = "DeleteFileRecordError"
	GetFileRecordError         = "GetFileRecordError"
	...
	InvalidNetworkPolicy       = "InvalidNetworkPolicy"
	...
	AppendTeamToContestError   = "AppendTeamToContestError"
	...
	DeleteAssociatedDataError  = "DeleteAssociatedDataError"
	...
	SaveTrafficError           = "SaveTrafficError"
...
var resp = map[string]map[string]interface{}{
	...
	CreateCheatError: {"zh-CN": "记录作弊失败", "en-US": "Failed to record cheat", "code": 500},
	DeleteCheatError: {"zh-CN": "删除作弊失败", "en-US": "Failed to delete cheat", "code": 500},
	GetCheatError:    {"zh-CN": "获取作弊失败", "en-US": "Failed to get cheat", "code": 500},
	CheatNotFound:    {"zh-CN": "作弊不存在", "en-US": "Cheat not found", "code": 404},
	...
	ContestIsComing:      {"zh-CN": "赛事未开始", "en-US": "Contest is coming", "code": 400},
	...
	DeleteFileRecordError: {"zh-CN": "删除文件失败", "en-US": "Failed to delete file", "code": 500},
	GetFileRecordError:    {"zh-CN": "获取文件失败", "en-US": "Failed to get file", "code": 500},
	...
	UpdateRankingError: {"zh-CN": "更新排名失败", "en-US": "Failed to update ranking", "code": 500},
	...
	InvalidNetworkPolicy:     {"zh-CN": "无效的NetworkPolicy", "en-US": "Invalid NetworkPolicy", "code": 400},
	ExecCommandError:         {"zh-CN": "执行POD命令失败", "en-US": "Failed to execute command", "code": 500},
	ZipError:                 {"zh-CN": "压缩文件失败", "en-US": "Failed to zip file", "code": 500},
	...
	CaptainCannotLeave: {"zh-CN": "队长不能退出队伍", "en-US": "Captain cannot leave team", "code": 400},
