...
func Init() {
	...
	err = DB.Set("gorm:table_options", "ENGINE=InnoDB").AutoMigrate(
		&model.Admin{}, &model.Challenge{}, &model.ChallengeFlag{}, &model.Container{}, &model.Contest{},
		&model.ContestChallenge{}, &model.ContestFlag{}, &model.Device{}, &model.Docker{}, &model.DockerGroup{},
		&model.Event{}, &model.File{}, &model.Notice{}, &model.Pod{}, &model.Request{}, &model.Submission{},
		&model.Team{}, &model.TeamFlag{}, &model.User{}, &model.Victim{},
	)
	if err != nil {
